...
class SimpleServiceClient(Node):
    def init(self, a , b):
        super().init("simple_service_client")

        self.client_ = self.create_client(AddTwoInts, "add_two_integers")
    ...
    def reponseCallback(self, future):
...
def main():
    ...
    if len(sys.argv) != 3:
        print("Wrong number of arguments. Please provide two integers")
        return -1
